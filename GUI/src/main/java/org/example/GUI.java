...
public class GUI {
    ...
    public void init() {
        try {
            ...
            Button groupleaveButton = new Button("send test", new Runnable() {
                @Override
                public void run() {
                    System.out.println("button pressed");
                }
            });
            groupCmds.addComponent(groupleaveButton);
            ...
            // Thread thread1 = new Thread(() -> createWindow("Window 1", "Hello, Window 1!"));
            // Thread thread2 = new Thread(() -> createWindow("Window 2", "Hello, Window 2!"));

            // Thread thread1 = new Thread(() -> guiWindow.init());
            // Thread thread2 = new Thread(() -> guiWindow2.init());

            // thread1.start();
            // thread2.start();
        }
        catch (Exception e) {
            System.out.println("exception occurred during GUI init: " + e);
        }
    } /* end init */
